...
package org.robotlegs.demos.imagegallery
{
	...
	public class ImageGalleryContext extends Context
	{
		...
		override public function startup():void
		{
			...
			commandMap.mapEvent(GalleryImageEvent.SET_GALLERY_IMAGE_SIZE, SetSizeImageCommand, GalleryImageEvent);
			commandMap.mapEvent(GalleryEvent.LOAD_GALLERY, LoadGalleryCommand, GalleryEvent);
			commandMap.mapEvent(GalleryStageEvent.STAGE_SIZE, SetStageSizeCommand, GalleryStageEvent);
